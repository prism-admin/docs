...
## Creating your first project
  ...
  files](agents//configuration/introduction) are simple YAML files, so don't worry about having to learn a new domain-specific
  language.
...
## Running your first project
  ...
  A full description of the CLI commands can be found [here](cli/overview).