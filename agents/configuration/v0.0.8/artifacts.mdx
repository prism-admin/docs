---
title: 'artifacts'
description: The `artifacts` key defines files to download after code execution
version: 'v0.0.8'
---
...
## Overview
  ...
  The `artifacts` key should contain the list of files to download from the cloud
  ...
  cloud environment. The `artifacts` allows you to access these files.
